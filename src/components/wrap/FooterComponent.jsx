    ...
    return (
        ...
        <footer id='footer'>
            ...
            <div className="row row2">
                <div className="container">
                    <a href="!#">
                        <span><img src="./img/footer/logo_isms.svg" alt="" /></span>
                        <span>
                    ...
                    <a href="!#">
                        <span><img src="./img/footer/logo_privacy.svg" alt="" /></span>
                        <span>
                            개인정보보호 우수 웹사이트 ·<br/>
                    ...
                    <a href="!#">
                        <span><img src="./img/footer/logo_tosspayments.svg" alt="" /></span>
                        <span>
                            토스페이먼츠 구매안전(에스크로)<br/>
                            서비스를 이용하실 수 있습니다.
                        </span>
                    ...
                    <a href="!#">
                        <span><img src="./img/footer/logo_wooriBank.svg" alt="" /></span>
                        <span>
